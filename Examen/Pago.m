...
- (IBAction)pagar:(id)sender {
    ...
    payment.amount = [[NSDecimalNumber alloc] initWithInt:_price];
    payment.currencyCode = @"MXN";
    payment.shortDescription = _name;
    ...
    //payment.shippingAddress = shipping; // a previously-created PayPalShippingAddress object
